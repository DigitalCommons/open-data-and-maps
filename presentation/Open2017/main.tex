...
The slides are topped and tailed with horizontal lines, like this:
...
\frame
{
  ...
  \begin{itemize}
    ...
    \item<4-> Starting with data to describe initiatives in the Solidarity Economy
  \end{itemize}
}
\slideend
\startslide
...
\frame
{
  ...
  \begin{itemize}
    ...
    \item Technically, ticks the boxes
      \begin{itemize}
