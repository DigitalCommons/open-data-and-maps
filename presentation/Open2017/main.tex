...
Some of the notes are quite geeky, and these can be skipped. They can be identified by the geek in the right margin, as in the next paragraph.
...
\frame
{
  ...
  \begin{itemize}
    ...
    \item Prefer appropriate ownership of data
      \begin{itemize}
	\item Links are better that copies
      \end{itemize}
