...
# input = File.open("/Volumes/Extra/SEA-dev/open-data-and-maps/data/newcastle-pilot/2019-07-03/original-data/2019-07-03-original.csv", "r:utf-8")
# inputContent = input.read;
# input.close
# $stdout.reopen("/Volumes/Extra/SEA-dev/open-data-and-maps/data/newcastle-pilot/2019-07-03/generated-data/experimental/csv/initiatives.csv", "w")
# $stderr.reopen("/Volumes/Extra/SEA-dev/open-data-and-maps/data/newcastle-pilot/2019-07-03/generated-data/experimental-new-server/csv/ignored-duplicates.csv", "w")
# $stdout.sync = true
# $stderr.sync = true
